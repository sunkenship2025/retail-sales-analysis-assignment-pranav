...
def save_metrics_to_db(conn: sqlite3.Connection, sales_by_branch: pd.DataFrame, top_articles: pd.DataFrame, monthly_revenue: pd.DataFrame, category_revenue: pd.DataFrame):
   """ 
